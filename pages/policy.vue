<template>
    <div class="text-white">
        ...
        >
            ...
            <p class="pb-4">1. Общие положения</p>
            <p class="pb-4">
                ...
                персональных данных&nbsp;ООО "ВДООХ"&nbsp;(далее &ndash;
                Оператор).
            </p>
            <ol class="pl-8 pb-8 list-decimal">
                ...
                <li>
                    ...
                    посетителях веб-сайта&nbsp;https://vdooh.com.
                </li>
            </ol>
            <p class="pb-4">2. Основные понятия, используемые в Политике</p>
            <ol class="pl-8 pb-8 list-decimal">
                <li>
                ...
                <li>
                    ...
                    Пользователю веб-сайта&nbsp;https://vdooh.com;
                </li>
                <li>
                    Пользователь &ndash; любой посетитель
                    веб-сайта&nbsp;https://vdooh.com;
                </li>
                <li>
            ...
            <p class="pb-4">4. Цели обработки персональных данных</p>
            <ol class="pl-8 pb-8 list-decimal">
                <li>
                    Цель обработки персональных данных Пользователя
                    &mdash;&nbsp;информирование Пользователя посредством
                ...
                <li>
                    ...
                    Оператору письмо на адрес электронной
                    почты&nbsp;info@vdooh.com&nbsp;с пометкой &laquo;Отказ от
            ...
            <ol class="pl-8 pb-8 list-decimal">
                <li>
                    ...
                    сайте&nbsp;https://vdooh.com. Заполняя соответствующие формы
                ...
                <li>
                    ...
                    случае, если это разрешено в настройках браузера
                    Пользователя (включено сохранение файлов
                    &laquo;cookie&raquo; и использование технологии JavaScript).
                </li>
            </ol>
            <p class="pb-4">
            ...
            <ol class="pl-8 pb-8 list-decimal">
                ...
                <li>
                    ...
                    Оператора&nbsp;info@vdooh.com&nbsp;с пометкой
                ...
                <li>
                    ...
                    адрес Оператора&nbsp;info@vdooh.com&nbsp;с пометкой
                    &laquo;Отзыв согласия на обработку персональных
                    данных&raquo;.
                </li>
            </ol>
            <p class="pb-4">7. Трансграничная передача персональных данных</p>
            <ol class="pl-8 pb-8 list-decimal">
                <li>
            ...
            <p class="pb-4">8. Заключительные положения</p>
            <ol class="pl-8 pb-8 list-decimal">
                <li>
                ...
                <li>
                    ...
                    сети Интернет по адресу&nbsp;<a
                        href="https://vdooh.com/privacy.html"
                        >https://vdooh.com/privacy.html</a
                    >.
                </li>
            </ol>
        </div>
